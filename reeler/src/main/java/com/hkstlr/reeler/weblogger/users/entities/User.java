...
@NamedQueries({
    ...
    , @NamedQuery(name = "User.findByEmailAddress", query = "SELECT r FROM User r WHERE r.emailAddress = :emailAddress")
    , @NamedQuery(name = "User.findByActivationCode", query = "SELECT r FROM User r WHERE r.activationCode  = :activationCode")
    , @NamedQuery(name = "User.findByDateCreated", query = "SELECT r FROM User r WHERE r.dateCreated = :dateCreated")
    , @NamedQuery(name = "User.findByLocale", query = "SELECT r FROM User r WHERE r.locale = :locale")
    , @NamedQuery(name = "User.findByTimeZone", query = "SELECT r FROM User r WHERE r.timeZone = :timeZone")
    , @NamedQuery(name = "User.findByIsEnabled", query = "SELECT r FROM User r WHERE r.isEnabled = :isEnabled")
